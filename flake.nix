  ...
  outputs =
    ...
    let
      ...
      pyprojectOverrides = _final: _prev: {
        ...
        spotdl = _prev.spotdl.overrideAttrs (old: {
          nativeBuildInputs = (old.nativeBuildInputs or []) ++
    ...
    in
      ...
      apps.x86_64-linux = {  # Nix run
        default = {
          type = "app";
          program = "${self.packages.x86_64-linux.default}/bin/spotdl";  # Changed from myapp to spotdl
        };
      };
          ...
          default =
            let
              ...
              editableOverlay = workspace.mkEditablePyprojectOverlay {
                ...
                # members = [ "spotdl" ];  # Changed from hello-world to spotdl
              };
              ...
              editablePythonSet = pythonSet.overrideScope (
                lib.composeManyExtensions [
                  ...
                  (final: prev: {
                    spotdl = prev.spotdl.overrideAttrs (old: {  # Changed from hello-world to spotdl
                      ...
                      src = lib.fileset.toSource {
                        ...
                        fileset = lib.fileset.unions [
                          ...
                          (lib.fileset.maybeMissing (old.src + "/spotdl"))  # Add spotdl source directory
                        ];
                      };
              ...
              virtualenv = editablePythonSet.mkVirtualEnv "spotdl-dev-env" workspace.deps.all;  # Changed name
            in
              pkgs.mkShell {
                packages = setup.packages;
                env = setup.env // {
